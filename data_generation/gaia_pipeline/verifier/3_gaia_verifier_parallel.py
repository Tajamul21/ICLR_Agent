...
### prompt setting
system_prompt_path = './data_generation/gaia_pipeline/verifier/prompt/gaia_file_verifier_system.prompt'
user_prompt_path = './data_generation/gaia_pipeline/verifier/prompt/gaia_file_verifier_user.prompt'
tool_description_path='./data_generation/gaia_pipeline/verifier/prompt/tool_description.json'
