...
DATA="data/train_20250814_1518.json"
...
"
export WANDB_PROJECT="mat_qwen_vl_gaia"
torchrun $DISTRIBUTED_ARGS finetune.py \
    --model_name_or_path $MODEL \
    --data_path $DATA \
    --bf16 True \
    --fix_vit True \
    --output_dir /share/data/drive_4/tj/MAT_Agent/results/training/E1_generated_data_359/Qwen2-VL-7B-Instruct-$SLURM_JOB_ID \
    --num_train_epochs 20 \
